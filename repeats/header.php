...
<ul class="side-nav-list" style="padding-top:100px">
    <li class="side-nav-list-items"><a href="about.php" class="side-nav-link">About</a></li>
...
if(isset($_SESSION['id'])) {
    echo '<li class="side-nav-list-items"><a href="profile.php" class="side-nav-link">Profile</a></li>';
    echo '<li class="side-nav-list-items"><a href="logout-code.php" class="side-nav-link">Log Out</a></li>';
    echo '<li class="sub-elements">Logged in as '.$_SESSION['id'].'</li>';
} else {
...
if(isset($_SESSION['id'])) {
    echo '<li class="sub-elements"><a href="profile.php">Profile</a></li>';
